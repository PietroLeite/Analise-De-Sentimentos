class Frases:
    ...
    basetreinamento = [
        ...
        ('O amável homem concordou em ajudar a caridade.', 'alegria'),
        ('Empolgado, o jovem garoto foi realizar a prova.', 'alegria'),
        ('O brilho do céu é cativante.', 'alegria'),
        ('O homem foi consagrado como o melhor de sua profissão.', 'alegria'),
        ('A dama foi condecorada por sua bravura.', 'alegria'),
        ('Em um momento complicado, o homem apoiou seu amigo.', 'alegria'),
        ('Com um enorme apoio, a empresa se dirigiu ao topo.', 'alegria'),
        ('A felicidade de uma criança é bela.', 'alegria'),
        ('Ao receber o presente, o garoto se encheu de alegria.', 'alegria'),
        ('O trabalhador se mostrou contente em seus resultados.', 'alegria'),
        ('Oh meu deus!', 'alegria'),
        ('A mulher chorou de alegria.', 'alegria'),
        ('Ele pulou de alegria.', 'alegria'),
        ('O garoto chorou de emoção.', 'alegria'),
        ...
        ('estou desapontado com você', 'desgosto'),
        ('estou desapontado com ele', 'desgosto'),
        ('Credo!', 'desgosto'),
        ('Me deu enjoo ver voce assim', 'desgosto'),
        ('Mas que coisa asquerosa!', 'desgosto'),
        ('Nao precisa ser grosseiro comigo', 'desgosto'),
        ('Que ser repugnante', 'desgosto'),
        ('Isso foi ultrajante!', 'desgosto'),
        ('Que atitude detestavel rapaz', 'desgosto'),
        ('Mano isso foi obsceno demais', 'desgosto'),
        ('Comentario desagradavel eim', 'desgosto'),
        ('Voce e muito patetico cara', 'desgosto'),
        ...
        (' homem ficou com medo de perder tudo.', 'medo'),
        ('O agente fez um recuo em sua ação.', 'medo'),
        ('O inimigo era forte, logo recuamos.', 'medo'),
        ('Não quero perder tudo.', 'medo'),
        ('O garoto apresentou tremor ao oculto.', 'medo'),
        ('A prova parece estar difícil.', 'medo'),
        ('A mulher ficou perturbada com a notícia.', 'medo'),
        ('Após o ocorrido, a mãe do garoto ficou preocupada.', 'medo'),
        ('O olhar sombrio do homem assustou o garoto.', 'medo'),
        ('A empresa corre risco de perder tudo.', 'medo'),
        ('Oh meu deus!', 'medo'),
        ('Espantado o garoto correu.', 'medo'),
        ('Todo mundo ficou chocado com esta noticia', 'medo'),
        ('E espantoso como ele reagiu a isto', 'medo'),
        ('Por favor tome cuidado para nao se machucar', 'medo'),
        ('Seria horrivel cair dessa altura', 'medo'),
        ('Todo mundo esta nervoso por causa dessa sua boca grande', 'medo'),
        ('O cemiterio é assombrado!', 'medo'),
        ('Fiquei muito assustado naquele lugar', 'medo'),
        ('Nao gosto de filmes de terror', 'medo'),
        ('Todo mundo fica tenso quando voce sai de casa', 'medo'),
        ('Um arrepio gelado correu minha espinha', 'medo'),
        ...
        ('nossa, eu vou matar ele', 'raiva'),
        ('esse só me estressa', 'raiva'),
        ('deixa de ser burro!', 'raiva'),
        ('desisto de você', 'raiva'),
        ('o que eu fiz para merecer isso?!', 'raiva'),
        ('Odeio lições de moral especialmente de quem não tem moral', 'raiva'),
        ('Se eu pudesse eu pegava a dor.Colocava dentro de um envelope e devolvia ao remetente', 'raiva'),
        ('Estou cansado.Cansado de pessoas sendo ruins umas com as outras', 'raiva'),
        ('Odeio quem fala tô chegando, quando ainda nem saiu de casa', 'raiva'),
        ('Odeio circo.Aliás, odeio tudo que me encanta e depois vai embora', 'raiva'),
        ('Odeio quando eu já preparei todo um discurso e a pessoa simplesmente pede desculpas', 'raiva'),
        ('Foi um desprazer te conhecer', 'raiva'),
        ('Estou furioso com sua atitude irresponsavel', 'raiva'),
        ('Voce aborreceu todo mundo falando isso', 'raiva'),
        ('Estou uma pilha de nervos com essa noticia', 'raiva'),
        ...
        ('E adimiravel sua atitude', 'surpresa'),
        ('Foi fantastico o jeito que voce saiu dessa', 'surpresa'),
        ('Cara estou tremendo, como voce fez aquilo!', 'surpresa'),
        ('Isso realmente superou as espectativas', 'surpresa'),
        ('Estou embasbacado com essa noticia', 'surpresa'),
        ('Voce encantou a todos com essa performance', 'surpresa'),
        ('O chefe ficou desconcertado com o que voce fez', 'surpresa'),
        ('Cara isso foi realmente de arrasar', 'surpresa'),
        ('To perplexo com isso velho', 'surpresa'),
        ('Voce e realmente um prodigio na area', 'surpresa'),

        ('O garoto chorou de emoção.', 'tristeza'),
        ('Ele se admirou com a notícia.', 'tristeza'),
        ('Ele se surpreendeu com o ocorrido.', 'tristeza'),
        ('Como isso foi acontecer? ', 'tristeza'),
        ('Ele se confundiu nas informações.', 'tristeza'),
        ('Ela ficou fascinada com a beleza da natureza.', 'tristeza'),
        ('Foi pego em flagrante.', 'tristeza'),
        ('Ela ficou pasma com o comunicado.', 'tristeza'),
        ('A revelação dos prêmios surpreendeu os participantes.', 'tristeza'),
        ('Espantado o garoto correu.', 'tristeza'),
        ('Oh meu deus!', 'tristeza'),
        ...
        ('A morte de um parente chateou o garoto', 'tristeza'),
        ('Com uma tristeza profunda o garoto chorou', 'tristeza'),
        ('A morte do animal chateou ele', 'tristeza'),
        ('Ouvia a vontade de morrer do pobre animal agonizado.', 'tristeza'),
        ('Ela ficou desolada após a perda de seu ente querida.', 'tristeza'),
        ('O ar melancólico pairava sobre o ambiente.', 'tristeza'),
        ('Eu quero morrer', 'tristeza'),
        ('Enquanto a chuva caia, o rapaz se perdia em seus pensamentos.', 'tristeza'),
        ('Ele agonizava de dor', 'tristeza'),
        ('O sofrimento do povo era grande na região', 'tristeza'),
        ('Me sinto abandonado por todos', 'tristeza'),
        ('Parece que ninguem vira pedir desculpas', 'tristeza'),
        ('A amargura e vergonha o impediu de ajudar o pai', 'tristeza'),
        ('E complicado quando todos te culpam por tudo', 'tristeza'),
        ('Nao consigo parar de chorar com a noticia', 'tristeza'),
        ('Desanimo define o dia de hoje', 'tristeza'),
        ('Sinto tanta falta dela', 'tristeza'),
        ('Fomos todos derrotados', 'tristeza'),
        ('E deprimente te ver no chao', 'tristeza'),
        ('Me sinto tao deslocado da sociedade', 'tristeza')]
    ...
    stopwords = ['agora', 'algum', 'alguma', 'aquele', 'aqueles',  'deu',   'estou', 'esta', 'esta',
                 'ir', 'meu', 'muito', 'mesmo', 'no', 'nossa',  'outro',   'sem', 'talvez', 'tem',
                 'tendo', 'tenha', 'teve', 'tive', 'todo', 'um', 'uma', 'umas', 'uns', 'vou',
                 'mais', 'as', 'dos', 'como', 'mas', 'foi', 'ao', 'ele', 'das', 'tem', 'à ', 'seu', 'sua', 'ou',
                 'de',  'a', 'o', 'que', 'e', 'do', 'da', 'em', 'um', 'para', 'é', 'com', 'não', 'uma', 'os', 'no',
                 'na', 'por', 'ser', 'quando muito', 'há', 'nos', 'já', 'está', 'eu', 'também', 'só', 'pelo', 'pela',
                 ...
                 'têm', 'numa', 'pelos', 'elas', 'havia', 'seja', 'qual', 'será', 'nós', 'tenho', 'lhe', 'eles',
                 'essas', 'esses', 'pelas', 'este', 'fosse', 'dele', 'tu', 'te', 'vocês', 'vos', 'lhes', 'meus',
                 ...
                 'houvemos', 'houveram', 'houvera', 'houvéramos', 'se',
